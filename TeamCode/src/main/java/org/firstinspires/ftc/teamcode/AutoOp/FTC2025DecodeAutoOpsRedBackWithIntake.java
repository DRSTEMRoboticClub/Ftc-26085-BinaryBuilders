...
@Autonomous
public class FTC2025DecodeAutoOpsRedBackWithIntake extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            drivetrain.drive_forward(1.0, -0.30, 1500);
            ...
            telemetry.addData("Mission Tag: ", sequenceId);
            telemetry.update();
            drivetrain.turn_to(47, 0.8, 2);
            //drivetrain.drive_backward(0.5, 300);
            drivetrain.turn_to(47, 0.2, 2);
            ...
            drivetrain.drive_forward(1.0, 0.3, 700);
            drivetrain.turn_to(45, 0.8, 2);
            drivetrain.turn_to(45, 0.2, 2);
            shootSequence();
            drivetrain.right(1.0, 1000);
        }
    }
