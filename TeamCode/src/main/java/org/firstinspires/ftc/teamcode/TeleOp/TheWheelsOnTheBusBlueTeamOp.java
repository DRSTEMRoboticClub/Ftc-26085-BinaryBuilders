...
@TeleOp
public class TheWheelsOnTheBusBlueTeamOp extends LinearOpMode {
    ...
    static final String teamColour = "Blue";
    ...
    public void humptyDumptyRobot() throws InterruptedException {
        missionArm.lift_arm(45.f);
        Thread.sleep(1000);
        missionArm.extend_arm(0.3f);
        Thread.sleep(1000);
        missionArm.lift_arm(60.f);
    }
