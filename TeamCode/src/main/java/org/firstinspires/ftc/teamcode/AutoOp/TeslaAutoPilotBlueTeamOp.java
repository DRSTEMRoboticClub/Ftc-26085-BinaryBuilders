...
@Autonomous
public class TeslaAutoPilotBlueTeamOp extends LinearOpMode {
    ...
    public void autoBotRollout() throws InterruptedException
    {
        ...
        // mission arm
        missionArm = new TheArmOnTheBus(telemetry, armMotorLeft, armMotorRight, armSlideMotor, intakeAngleServo, intakeFlapWheelMotor, colourSensor, "Blue");
