...
public class MecanumLocalizer {
    ...
    public MecanumLocalizer(HardwareMap hMap) {
    ...
    /**
     * Update the pose estimate.  Accepts the heading from DriveSubsystem so we
     * share the same cached IMU read instead of issuing a second I2C transaction.
     *
     * @param driveHeadingDeg heading in degrees from {@code DriveSubsystem.getHeading()}
     */
    public void update(double driveHeadingDeg) {
